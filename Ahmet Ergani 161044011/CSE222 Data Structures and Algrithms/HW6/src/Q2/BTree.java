...
public class BTree<E extends Comparable<E>>  implements SearchTree<E> {
    ...
    /**
     *
     * @param item the item to be inserted or found
     * @param data information of local root
     * @param from starting point
     * @param to finishing point
     * @return the index of the item if it is in the data[], the suitable index for item to insert if it is not
     */
    public int binarySearch(E item, E[] data,int from ,int to)
    {
        if (from < to)
        {
